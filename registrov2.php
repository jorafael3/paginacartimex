...
$provincias = array(
  array("id" => "01", "nombre" => "Azuay"),
  array("id" => "02", "nombre" => "Bolívar"),
  array("id" => "03", "nombre" => "Cañar"),
  array("id" => "04", "nombre" => "Carchi"),
  array("id" => "05", "nombre" => "Chimborazo"),
  array("id" => "06", "nombre" => "Cotopaxi"),
  array("id" => "07", "nombre" => "El Oro"),
  array("id" => "08", "nombre" => "Esmeraldas"),
  array("id" => "09", "nombre" => "Galápagos"),
  array("id" => "10", "nombre" => "Guayas"),
  array("id" => "11", "nombre" => "Imbabura"),
  array("id" => "12", "nombre" => "Loja"),
  array("id" => "13", "nombre" => "Los Ríos"),
  array("id" => "14", "nombre" => "Manabí"),
  array("id" => "15", "nombre" => "Morona Santiago"),
  array("id" => "16", "nombre" => "Napo"),
  array("id" => "17", "nombre" => "Orellana"),
  array("id" => "18", "nombre" => "Pastaza"),
  array("id" => "19", "nombre" => "Pichincha"),
  array("id" => "20", "nombre" => "Santa Elena"),
  array("id" => "21", "nombre" => "Santo Domingo de los Tsáchilas"),
  array("id" => "22", "nombre" => "Sucumbíos"),
  array("id" => "23", "nombre" => "Tungurahua"),
  array("id" => "24", "nombre" => "Zamora Chinchipe")
...
<main class="page registration-page">
  <section class="clean-block clean-form dark">
    <div class="container">
      ...
      <form method="POST" action="registro2v2.php" enctype="multipart/form-data">

        <div class="form-check">
          <input class="form-check-input" type="radio" value ="0"  name="p_natural" id="flexRadioDefault1" checked>
          <label class="form-check-label" for="flexRadioDefault1">
            Persona Natural
          </label>
        </div>
        <div class="form-check mb-3">
          <input class="form-check-input" type="radio" value ="1" name="p_natural" id="flexRadioDefault2">
          <label class="form-check-label" for="flexRadioDefault2">
            Persona Jurídica
          </label>
        </div>
        <div class="form-group">
          <label for="ruc">Número de Cedula / Ruc (13 dígitos) <span class="text-danger">*</span></label>
          <input onkeypress="return valideKey(event);" maxlength="13" minlength="10" class="form-control item" type="text" id="ruc" name="ruc" pattern="[0-9]{13}" required>
        </div>
        <div class="form-group">
          <label for="ruc">Nombres <span class="text-danger">*</span></label>
          <input class="form-control item" type="text" id="nombres" name="nombres"required>
        </div>
        <div id="SP_J" style="display: none;">
          <div class="form-group">
            <label for="name">Razón Social (Nombre de Empresa) <span class="text-danger">*</span></label>
            <input class="form-control item" type="text" id="name" name="razon_social" >
          </div>
          <div class="form-group">
            <label for="rlegal">Nombre del Representante Legal <span class="text-danger">*</span></label>
            <input class="form-control item" type="text" id="rlegal" name="rlegal" placeholder="NOMBRE APELLIDO1 APELLIDO2" >
          </div>
          <div class="form-group">
            <label for="cedula">Cédula del Representante Legal (10 dígitos) <span class="text-danger">*</span></label>
            <input onkeypress="return valideKey(event);" maxlength="10" minlength="10" class="form-control item" type="text" id="cedula" name="cedula" pattern="[0-9]{10}" >
          </div>
        </div>

        <div class="form-group">
          <label for="email">actividad Comercial <span class="text-danger">*</span> </label>
          <input class="form-control item" type="text" id="text" name="actividad_comercial" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="ciudad">Provincia <span class="text-danger">*</span></label>
          <select name="provincia" id="provincia" class="form-control" onchange="SET_CIUDADES(this.value)">
        ...
        <div class="form-group">
          ...
          <input class="form-control item" type="text" id="direccion" name="direccion" required>
        </div>
        <div class="form-group">
          <label for="celular">Teléfono Celular (10 dígitos) <span class="text-danger">*</span></label>
          <input onkeypress="return valideKey(event);" maxlength="10" class="form-control item" type="text" id="celular" name="celular" placeholder="09XXXXXXXX" pattern="[0-9]{10}" required>
        </div>
        <div class="form-group">
          <input type="checkbox" id="terminos" name="terminos" required checked>
          He leído y acepto el tratamiendo de datos personales, recibir información personalizada, descuentos y promociones exclusivas de CARTIMEX por cualquier medio.

        </div>
        <div class="form-group">
          <input type="checkbox" id="terminos_prt" name="terminos_prt" checked>
          He leído y acepto
          <a href="#!" onclick="openmodal1()" class="ms-1 link-primary">
            Términos, condiciones y Políticas de Privacidad</a>
        </div> <br />
        <!-- Button trigger modal -->
        <!-- <button type="button" class="btn btn-secondary btn-block" data-toggle="modal" data-target="#Modal2">
          Ver Términos y Condiciones
        </button> -->
        <button class="btn btn-primary btn-block" type="submit" name="Enviar_Datos">Enviar Datos</button>
      </form>
    </div>
...
<script>
  $("#flexRadioDefault1").on("change", function(x) {
    console.log('x: ', "asdasdasd");
    $("#SP_J").hide(100);
  })
  $("#flexRadioDefault2").on("change", function(x) {
    console.log('x: ', "asdasdasd");
    $("#SP_J").show(100);
  })
  ...
  function SET_CIUDADES(id) {
    console.log('id: ', id);
    let ciudades = ciudadesPorProvincia[id];
    var selectProvincias = $('#ciudad');
    selectProvincias.empty();
    selectProvincias.append('<option value="">seleccione');
    ciudades.map(function(x) {
      console.log('x: ', x);
