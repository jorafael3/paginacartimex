...
$data_present = false;
if (isset($_POST["nombre"]) && isset($_POST["ruc"]) && isset($_POST["email"]) && isset($_POST["ciudad"]) && isset($_POST["direccion"]) && isset($_POST["celular"]) && isset($_POST["cedula"]) && isset($_POST["rlegal"])) {
    $data_present = true;
} else {
...
// CLEAN USER INPUT
$clean_nombre = filter_var($_POST["nombre"], FILTER_SANITIZE_STRING);
